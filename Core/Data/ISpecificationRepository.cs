namespace Core.Data
{
    ...
    public interface ISpecificationRepository<TModel> where TModel : class
    {
        ...
        TModel FindSingleBySpecification(Specification<TModel> specification, LoadingConfiguration<TModel> loader = null);
        ...
        IEnumerable<TModel> FindAllBySpecification(Specification<TModel> specification, LoadingConfiguration<TModel> loader = null);
    }
}
