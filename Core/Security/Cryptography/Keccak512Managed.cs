namespace Core.Security.Cryptography
{
    ...
    /// </summary>
    public sealed class Keccak512Managed : SHA3
    {
        /// <summary>
        /// The Keccak sponge instance.
        /// </summary>
        private readonly KeccakSpongeManaged sponge = new KeccakSpongeManaged(72, 128, KeccakSpongeManaged.KeccakDelimiter, 64);

        /// <summary>
        /// Initializes an implementation of the <see cref="Keccak224Managed"/> class.
        /// </summary>
