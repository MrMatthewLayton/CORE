namespace Core.Security.Cryptography
{
    ...
    {
        private static readonly ulong[] IotaRoundConstants = new ulong[]
        {
        ...
        protected SHA3(int rateBytes, int capacityBytes, int delimiter, int outputLength)
        {
        ...
        public static SHA3 Create224() => new SHA3Managed(144, 56, 0x06, 28);
        public static SHA3 Create256() => new SHA3Managed(136, 64, 0x06, 32);
        public static SHA3 Create384() => new SHA3Managed(104, 96, 0x06, 48);
        public static SHA3 Create512() => new SHA3Managed(72, 128, 0x06, 64);

        public static SHA3 CreateShake128(int outputByteLength) => new SHA3Managed(168, 32, 0x1f, outputByteLength);
        public static SHA3 CreateShake256(int outputByteLength) => new SHA3Managed(136, 64, 0x1f, outputByteLength);
